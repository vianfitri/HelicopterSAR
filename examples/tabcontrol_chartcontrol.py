...
class CustomTabControl(wx.Control):
    ...
    def OnPaint(self, event):
        ...
        # Pengaturan Antialiasing yang Benar
        ...
        for i, tab_label in enumerate(self.tabs):
            ...
            if i == self.selected_index:
                ...
                # Garis Bawah Safety Orange Menyala (Glow Effect)
...
class TimelineChartControl(wx.Control):
    ...
    def OnPaint(self, event):
        ...
        # 3. Interactive Review Hover Tooltip & Line
